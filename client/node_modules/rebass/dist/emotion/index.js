...
var Box = (0, _reactEmotion.default)('div')(_styledSystem.space, _styledSystem.width, _styledSystem.fontSize, _styledSystem.color, _styledSystem.flex, _styledSystem.order, _styledSystem.alignSelf, themed('Box'), css);
exports.Box = Box;
...
var Flex = (0, _reactEmotion.default)(Box)({
  display: 'flex'
...
var Text = (0, _reactEmotion.default)(Box)(_styledSystem.fontFamily, _styledSystem.fontWeight, _styledSystem.textAlign, _styledSystem.lineHeight, _styledSystem.letterSpacing, themed('Text'));
exports.Text = Text;
...
var Heading = (0, _reactEmotion.default)(Text)(themed('Heading'));
...
var Link = (0, _reactEmotion.default)(Box)(themed('Link'));
exports.Link = Link;
Link.defaultProps = {
  as: 'a',
  color: 'blue'
};
var Button = (0, _reactEmotion.default)(Box)({
  appearance: 'none',
...
var Image = (0, _reactEmotion.default)(Box)({
  maxWidth: '100%',
  height: 'auto'
...
var Card = (0, _reactEmotion.default)(Box)(_styledSystem.borders, _styledSystem.borderColor, _styledSystem.borderRadius, _styledSystem.boxShadow, _styledSystem.backgroundImage, _styledSystem.backgroundSize, _styledSystem.backgroundPosition, _styledSystem.backgroundRepeat, _styledSystem.opacity, themed('Card'), cards);
exports.Card = Card;
